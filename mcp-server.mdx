...
<Info>
  **Beta** — The Pierview MCP server is currently in beta. Tool names, parameters, and response formats may change as we iterate. We'll do our best to communicate breaking changes in advance.
</Info>

## Overview

The Pierview MCP server lets AI tools like Claude Desktop, Claude Code, and Cursor query your AI visibility data directly. Ask questions about your citations, key metrics, and competitor mentions without leaving your workflow.

## Prerequisites

- A [Pierview](https://pierview.ai) account with an active project
  ...
  <Tab title="Cursor">
    <Steps>
      ...
      <Step title="Add the MCP server">
        ...
        - **URL**: `https://mcp.pierview.ai/`
      </Step>
      <Step title="Authenticate">
        Open the Composer with an MCP-capable model. You will be prompted to sign in with your Pierview account on first use.
      </Step>
    </Steps>
  </Tab>
</Tabs>
...
**Returns:** Per-competitor, per-LLM mention percentages with provider and importance metadata.
