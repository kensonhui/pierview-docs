...
author: "Pierview AI"
"article:published_time": "2026-06-12T00:04:16+05:30"
---
...
<Frame>
  <img src="/images/webflow/webflow-site-settings-dropdown.png" alt="Webflow top-left menu dropdown with Site settings highlighted" />
</Frame>

2. In the settings sidebar, click **Apps & integrations**.

<Frame>
  <img src="/images/webflow/webflow-apps-integrations-nav.png" alt="Webflow site settings sidebar with Apps & Integrations highlighted" />
</Frame>

3. Scroll to the **API access** section and click **Generate API token**.

<Frame>
  <img src="/images/webflow/webflow-api-access-generate.png" alt="Webflow API access section with the Generate API token button" />
</Frame>
