...
1. In Webflow, open your **CMS collection** (e.g. "Blog Posts") — you'll see your existing fields listed here.
...
Open any content generation and click **Publish** in the top-right sidebar. Choose **Save as Draft** (staged in Webflow, not visible to visitors yet) or **Publish Live** to make it live. Re-publishing the same article updates the existing item — it will never create a duplicate.
...
<AccordionGroup>
  ...
  <Accordion title="I can't edit the article body in Webflow Designer">
    This is expected. Because the article body lives inside a Code Embed, it is not directly editable in Webflow Designer. Make your changes in Pierview and re-publish — the Webflow item updates automatically.
  </Accordion>
</AccordionGroup>
