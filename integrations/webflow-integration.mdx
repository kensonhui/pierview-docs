...
The one limitation: Webflow's Rich Text field strips tables. If an article contains a table, use the **copy button** on that table in the Pierview content editor to copy it as HTML, then embed it where you want it in Webflow.
