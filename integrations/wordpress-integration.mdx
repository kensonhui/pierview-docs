...
<Info>
  This integration works with **self-hosted WordPress** (WordPress.org on any host, e.g. Hostinger, Bluehost, SiteGround, Kinsta, WP Engine) **and WordPress.com** — both use Application Passwords over the same REST API.
</Info>
...
<AccordionGroup>
  ...
  <Accordion title="My site is on WordPress.com, why won't it connect?">
    WordPress.com supports Application Passwords. Go to your WordPress.com profile and scroll down to **Application Passwords** to generate one, then use it the same way as a self-hosted site. If it still fails, confirm your site URL is correct and that it uses HTTPS.
  </Accordion>
