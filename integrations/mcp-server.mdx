...
<Tabs>
  <Tab title="Claude Desktop">
    <Steps>
      <Step title="Browse connectors">
        Open Claude settings, select **Connectors** under **Customize**, click **Add**, then select **Browse connectors**.
      ...
      <Step title="Find Pierview">
        ...
        <img src="/images/mcp/claude-search-pierview.png" alt="Pierview shown in the Claude Connectors Directory search results" />
      </Step>
  ...
  <Tab title="Claude Code">
    <Steps>
      <Step title="Connect Pierview to Claude">
        Follow the steps in the **Claude Desktop** tab to connect Pierview from the Connectors Directory.
      </Step>
      <Step title="Start Claude Code">
        Run `claude` in your terminal and sign in with the same Claude account you used to connect Pierview.
      </Step>
