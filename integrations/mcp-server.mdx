...
<Info>
  **Beta** — The Pierview MCP server is currently in beta. Tool names,
  parameters, and response formats may change as we iterate. We'll do our best
  to communicate breaking changes in advance.
</Info>
...
<Tabs>
  ...
  <Tab title="Claude Code">
    <Steps>
      ...
      <Step title="Authenticate">
        Run thee ```/mcp``` command in your Claude Code instance. This will allow you to select the pierview mcp server. On authentication, it'll prompt you to login via the browser.
      </Step>
    </Steps>
  </Tab>
</Tabs>
