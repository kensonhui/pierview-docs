...
author: "Pierview AI"
"article:published_time": "2026-03-14T21:59:06-04:00"
---
...
The Pierview connector lets Claude on the web, Desktop, mobile, Claude Code, and ChatGPT query your AI visibility data directly. Ask questions about your citations, key metrics, and competitor mentions without leaving your workflow. You can also read and edit your [brand kit](#update_brand_kit) — have Claude structure your brand guidelines and save them back to Pierview.
  ...
  <Tab title="Claude web & Desktop">
    <Steps>
      <Step title="Browse connectors">
        ...
        <img src="/images/mcp/claude-browse-connectors.png" alt="Claude connector settings with the Browse connectors option highlighted" />
      </Step>
      <Step title="Find Pierview">
      ...
      <Step title="Connect and authenticate">
        ...
        <img src="/images/mcp/claude-connect-pierview.png" alt="Pierview connector details with the Connect button" />
      </Step>
    </Steps>
  ...
  <Tab title="ChatGPT">
    <Steps>
      <Step title="Open Plugins">
        ...
        <img src="/images/mcp/chatgpt-plugins-sidebar.png" alt="ChatGPT sidebar with the Plugins entry highlighted" />
      </Step>
      <Step title="Search for Pierview">
        Click the search bar on the Plugins page and type **Pierview**, then select the Pierview plugin from the results.

        <img src="/images/mcp/chatgpt-search-pierview.png" alt="ChatGPT Plugins page showing the Pierview plugin in search results" />
      </Step>
      <Step title="Install and authenticate">
        Install the plugin, then sign in to Pierview and approve access to your data.
      </Step>
    </Steps>
  ...
  <Tab title="Claude Code">
    <Steps>
      ...
      <Step title="Verify the connection">
        Run `/mcp` in Claude Code and confirm that Pierview is connected.
      </Step>
    </Steps>

    <Note>
      For API-key authentication or project-specific configuration, use the manual setup instructions in [API Keys](#api-keys).
    </Note>
...
<Info>
  **Write tool.** Unlike the read-only data tools, `update_brand_kit` modifies
