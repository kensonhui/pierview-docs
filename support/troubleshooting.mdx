...
- **Baseline** — You may have zero visibility today; use this as your starting point for [optimization](/core-features/actions/optimization)
...
- Check [Glossary](/support/glossary) for term definitions
