...
- Configure [Optimization](/core-features/actions/optimization) actions from report gaps
- Use [Playbooks](/playbooks/overview) to execute on recommendations
- Export or share via your preferred cadence
